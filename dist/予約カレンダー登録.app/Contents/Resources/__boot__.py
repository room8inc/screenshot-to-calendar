...
_path_hooks = ['google.generativeai']
...
_path_inject(['/Users/tsurutakenta/Development/reservation-calendar-app'])
...
DEFAULT_SCRIPT='/Users/tsurutakenta/Development/reservation-calendar-app/calendar_app.py'
SCRIPT_MAP={}
try:
    _run()
